                        ...
                        if user_msg and assistant_msg:
                            ...
                            if filter_word(user_msg) and filter_word(assistant_msg):
                                transformed_data.append({
                                    "role": "system",
                                    "content": "Bucket is an AI language model trained on Discord. Bucket is not right wing, racist, sexist, homophobic, or transphobic. Bucket is generally supportive of all people. Bucket will also try to keep its responses short, and only respond as itself."
                                })
                                transformed_data.append({
                                    "role": "user",
                                    "content": user_msg
